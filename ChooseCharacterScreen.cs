...
namespace No_Colors
{
    class ChooseCharacterScreen : Screen
    {
        ...
        public ChooseCharacterScreen(Hardware hardware) : base(hardware)
        {
            ...
            imgchoose = new Image("imgs/ChooseCharacter.gif", 1200, 740);
            imgLHand = new Image("imgs/left_hand_light.gif", 144, 144);
            imgLNoHand = new Image("imgs/left_hand_dark.gif", 144, 144);
            imgRHand = new Image("imgs/right_hand_light.gif", 144, 144);
            imgRNoHand = new Image("imgs/right_hand_dark.gif", 144, 144);
